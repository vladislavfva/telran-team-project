    ...
    <div className={classes.filters}>
      <div className={classes.inputs}>
        ...
        <input
          type="number"
          placeholder="from"
          onChange={(e) => handlePrice(e.target.value, undefined)}
          onWheel={(e) => e.target.blur()}
        />
        <input
          type="number"
          placeholder="to"
          onChange={(e) => handlePrice(undefined, e.target.value)}
          onWheel={(e) => e.target.blur()}
        />
      </div>
      ...
      <div className={classes.select_wrapper}>
        ...
        >
          ...
          <option value="decrease">decrease by price</option>
          <option value="increase">increase by price</option>
        </select>
      </div>
    </div>
  );
