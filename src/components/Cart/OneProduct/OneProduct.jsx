...
function OneProduct({product}) {
  ...
  return ( <div className={classes.one_product}>
    <img src={process.env.REACT_APP_BACKEND_BASE_URL + product.image} alt={product.title} className={classes.preview}/>
    <div className={classes.info}>
      <div className={classes.top_info}>
        <p className={classes.title}>{product.title}</p>
        <button className={classes.button} onClick={() => dispatch(removeFromCart({product}))}>
          <RemoveIcon />
        </button>
      </div>
      <div className={classes.wrapper}>
        <div className={classes.counter}>
          <button className={classes.button_counter} onClick={() => decreaseCounter()}>
            <DecreaseIcon />
          </button>
          <p className={classes.counter_text}>{product.amount}</p>
          <button className={classes.button_counter} onClick={() => increaseCounter()}>
            <IncreaseIcon />
          </button>
        </div>
        {
